...
if(request.getAttribute("error_msg")!=null){
	mesg = (String)request.getAttribute("error_msg");
} %>
		...
		<div class="container-login100">
			<div class="wrap-login100 p-t-50 p-b-90">
				<form class="login100-form validate-form flex-sb flex-w" action="login" method="post">
					<span class="login100-form-title p-b-51"> Doctor Login </span>
					...
					<div class="wrap-input100 validate-input m-b-16"
						...
						<input class="input100" type="password" name="loginPassword"
